    ...
    return(
        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 min-w-[350px]">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href={`/book/${props.id}`} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 min-w-28">Read More <span className="font-bold">&#8594;</span></a>
                </div>
            </div>
        </div>
    )
